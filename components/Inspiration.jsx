...
export default function Inspiration(){
  return(
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5" >
       <a href="https://realfood.tesco.com/recipes/bacon-and-mushroom-breakfast-hash.html" target="_blank" rel="noreferrer">
      ...
      <img src="/bacon1.png"></img>
       ...
       <a href="https://realfood.tesco.com/recipes/bacon-and-spinach-spaghetti.html" target="_blank" rel="noreferrer">
      <div className="cursor-pointer">
      ...
      <a href="https://realfood.tesco.com/recipes/bacon-and-tomato-muffins.html" target="_blank" rel="noreferrer">
        <div className="cursor-pointer">
